...
def build_transforms(cfg, is_train=True):
    ...
    if cfg.INPUT.USE_DETR_AUG:
        scales = [480, 512, 544, 576, 608, 640, 672, 704, 800]
        normalize = T.Compose([
            T.ToTensor(),
            T.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225], False)
            ])
        if is_train:
            return T.Compose([
                ...
                T.RandomAjustImage(),
                T.RandomSelect(
                    T.Resize(scales, max_size=1333),
                    T.Compose([
                        T.Resize([400, 500, 600], max_size=-1),
